...
<template>
    <div class="container">
        <div class="row">
            <div class="col-sm-4">
                <h3 class="mb-3">Quản lý học sinh</h3>
                <form @submit.prevent="submitForm" class="mb-4">
                    ...
                    <div class="mb-3 text-start">
                        ...
                        <input type="number" class="form-control" v-model="student.score" min="0" max="10" required>
                    </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr v-for="(stu, index) in students" :key="index">
                            ...
                            <td>{{ stu.score }}</td>
                            <td>{{ stu.dob }}</td>
                            <td><button class="btn btn-warning" @click="editStudent(index)">Sửa</button></td>
